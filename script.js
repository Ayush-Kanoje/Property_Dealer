...
const testimonials = [
  {
    ...
    role: "Home Buyer",
    content:
      "PropertyHub made finding our dream home incredibly easy. The search filters were perfect and the team was very professional throughout the entire process.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    content:
      "I've used several property platforms, but PropertyHub stands out with its detailed listings and market insights. Highly recommend for serious buyers.",
    rating: 4.8,
    avatar:
  ...
  },
  {
    ...
    content:
      "The team at PropertyHub guided me through my first home purchase with patience and expertise. I couldn't have asked for better service.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    role: "Seller",
    content:
      "Listing my property on PropertyHub was quick and hassle-free. I received genuine leads within a week and closed the deal smoothly.",
    rating: 5,
    avatar:
      "https://images.unsplash.com/photo-1603415526960-f7e0328d5b9b?w=100&h=100&fit=crop&crop=face",
  },
  {
    id: 5,
    ...
    role: "Tenant",
    content:
      "I was searching for a rental flat in a new city and PropertyHub made the process so much simpler. Clear details, verified listings, and no surprises!",
    rating: 4.2,
    avatar:
  ...
  },
  {
    ...
    role: "Property Agent",
    content:
      "As a realtor, PropertyHub gives me a reliable platform to connect with serious buyers. The dashboard is easy to use and saves me a lot of time.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    role: "Home Buyer",
    content:
      "From browsing to booking site visits, the entire experience felt seamless. PropertyHub really understands what buyers need.",
    rating: 4.1,
    avatar:
...
const features = [
  {
    ...
    description:
      "Calculate your monthly EMI with different loan amounts and interest rates",
  ...
  },
  {
    ...
    description:
      "Discover top localities and investment opportunities in your city",
    icon: "fas fa-map-pin",
...
const values = [
  ...
  },
  {
    ...
    description:
      "Our clients are at the heart of everything we do. We listen, understand, and deliver solutions tailored to their unique needs.",
  },
  {
    icon: "fas fa-chart-line",
    title: "Innovation",
    description:
      "We embrace technology and innovative approaches to make real estate transactions smoother and more efficient.",
  },
];
  ...
  return `
        <div class="property_card bg-white rounded-lg shadow-sm border overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div class="p-6">
                ...
                <button class="w-full px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors" onclick="viewPropertyDetails(${
                  property.id
                })">
                    View Details
                </button>
...
function viewPropertyDetails(propertyId) {
  ...
  if (property) {
    alert(
      `Viewing details for: ${property.title}\nPrice: ${property.price}\nLocation: ${property.location}`
    );
  }
}
...
function updateFeatureCarousel() {
  ...
  carousel.innerHTML = visibleFeatures
    .map(
      (feature, index) => `
        <div class="carousel_item">
            <div class="feature_card bg[-#eef1f0] rounded-2xl shadow-lg border-2 border-transparent hover:border-primary/20 p-8 cursor-pointer group transition-all duration-500 hover:shadow-2xl" style="animation-delay: ${
              index * 0.1
            }s;">
                <div class="text-center">
                    <div class="p-4 rounded-2xl ${
                      feature.color
                    } w-16 h-16 mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
...
function updatePaginationDots() {
  ...
  for (let i = 0; i < totalPages; i++) {
    ...
    dot.className = `pagination_dot w-3 h-3 rounded-full transition-all ${
      Math.floor(currentFeatureIndex / 3) === i
        ? "bg-primary"
...
function applyFilters() {
  ...
  filteredProperties = allProperties.filter((property) => {
    ...
    if (locationFilter) {
      matches =
        matches && property.location.toLowerCase().includes(locationFilter);
    }
            ...
            ${[...testimonials, ...testimonials]
              .map(
                ...
                <div class="testimonial_card bg-white rounded-lg shadow-sm border p-6">
                  ...
                  testimonial.name
                }" class="h-10 w-10 rounded-full object-cover" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
    ...
    teamContainer.innerHTML = teamMembers
      .map(
        (member) => `
          ...
          member.name
        }" class="w-24 h-24 rounded-full object-cover" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
